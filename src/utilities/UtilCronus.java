...
public class UtilCronus {
	...
	// hämtar både pk & fk
		...
		public String getIndex() {
			return "select top 10 object_id, name, index_id, type, type_desc"
	...
	public String getEmployeeColumns1() {
		return "select name as [Employee Columns] from sys.columns " + "where object_id=object_ID('CRONUS Sverige AB$Employee')";
	}
